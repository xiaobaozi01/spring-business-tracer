...
const samples = {
  ...
  run: { schemaVersion: "2.0", runId: "run-schema", phase: "PLANNED", configHash: hash, sourceSnapshot: hash, indexFingerprint: hash, toolkitFingerprint: hash, resolutionContextHash: hash, adapterRegistryFingerprint: hash, batchingPolicy: { batchSize: 10, retryLimit: 2, discoveryLeaseSeconds: 3600, leaseSeconds: 3600, heartbeatSeconds: 300 }, mode: "FULL", sharedModuleSnapshots: {}, discovery: { started: false, units: {} }, units: { entry: { id: "entry", service: "order", kind: "HTTP", status: "PENDING", attempts: 0, fingerprintToken: null } }, audits: { coverageHash: null, boundaryHash: null, configHash: null } },
